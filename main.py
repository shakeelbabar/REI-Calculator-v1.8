...
class SettingsWindow(QDialog):
    def __init__(self, parent=None):
        ...
        # set default colors
        self.ui.caption_bgcolor_button.setStyleSheet("QPushButton { background-color: orange }")
        self.ui.caption_bgcolor_button.text = ""
        self.ui.special_row_bgcolor_button.setStyleSheet("QPushButton { background-color: blue }")
        self.ui.special_row_bgcolor_button.text = ""
    ...
    def save_settings(self):
        #caption_bgcolor = self.ui.caption_bgcolor_label.text().strip()
        #special_row_bgcolor = self.ui.special_row_bgcolor_label.text().strip()
        self.settings.setValue("caption_bgcolor", "")
        self.settings.setValue("special_row_bgcolor", "")
        self.close()
...
class CalculatorWindow(QtWidgets.QMainWindow):
    ...
    def set_dataframe_style(self):
        ...
        df.style.set_properties(**{'background-color': 'green',
                                'color': 'white',
                                'border-color': 'white'}, subset=IndexSlice[1, ['id', 'count', 'type']])        
